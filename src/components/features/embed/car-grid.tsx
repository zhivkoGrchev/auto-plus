...
export function CarGrid({ cars, theme = 'light', slug }: CarGridProps) {
  ...
  return (
    <div
      className={`min-h-screen py-8 px-4 sm:px-6 lg:px-8 ${isDark ? 'bg-linear-to-br from-gray-900 via-gray-900 to-gray-800' : 'bg-linear-to-br from-gray-50 via-white to-gray-100'}`}
    >
          ...
          {cars.map((car) => (
            ...
            >
              ...
              <div className="p-5">
                ...
                {/* View Details Button */}
                <a
                  href={`/embed/${slug}/${car.id}?source=embed`}
