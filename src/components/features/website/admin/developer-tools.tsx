...
export function DeveloperTools({ slug }: DeveloperToolsProps) {
...
></iframe>`
  ...
  src="${appUrl}/embed/${slug}?theme=dark"
  width="100%"
  height="800"
  frameborder="0"
  style="border: none;"
          ...
          <div className="pt-4 border-t">
            ...
            <div className="flex gap-2">
              ...
              <Button variant="outline" size="sm" asChild>
                <a href={`/embed/${slug}?theme=dark`} target="_blank" rel="noopener noreferrer">
                  <ExternalLink className="h-4 w-4 mr-2" />
                  {t('previewDarkTheme')}
                </a>
              </Button>
