...
import { AlertCircle, CheckCircle2, Clock, Copy, ExternalLink, Plus, Save, Trash2 } from 'lucide-react'
...
export const OpeningHours = ({ slug }: OpeningHoursProps) => {
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          <Button variant="default" size="sm" asChild disabled={!slug}>
            <a href={slug ? `${process.env.NEXT_PUBLIC_APP_URL || 'http://localhost:3000'}/${slug}` : '#'} target="_blank" rel="noopener noreferrer">
