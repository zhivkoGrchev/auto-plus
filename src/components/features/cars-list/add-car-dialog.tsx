            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-start">
              <fieldset className="flex flex-col">
                <div className="flex items-center gap-2">
                  <label
                    className="w-24 text-right text-neutral-700 dark:text-neutral-300"
                    htmlFor="brandId"
                  >
                    {t("brand")}
                  </label>
                      ...
                      {isPendingBrands ? (
                        ...
                        carData.brands.map((item) => (
                          <SelectItem
                            key={item.id}
                            value={item.id}
                            className="data-[highlighted]:bg-cyan-200 dark:data-[highlighted]:bg-cyan-800"
                          >
                            {item.name}
                          </SelectItem>
                        ))
                ...
                {getFieldError("brandId") && (
                  <p className="ml-26 mt-1 text-sm text-red-600">
                    {getFieldError("brandId")}
                  </p>
                )}
              </fieldset>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Select
                    ...
                    onValueChange={(modelId) =>
                      setCarData((prev) => ({ ...prev, modelId }))
                    }
                    onOpenChange={handleOpenModels}
                  >
                    <SelectTrigger
                      className="border-cyan-900 dark:border-cyan-600 bg-cyan-100 focus:bg-cyan-200 dark:bg-cyan-900 dark:focus:bg-cyan-800 text-foreground outline-offset-2 focus:outline-1 focus:outline-neutral-400 dark:outline-neutral-600"
                      aria-label="Model"
              ...
              <fieldset className="flex flex-col">
                <div className="flex items-center gap-2">
                  ...
                  <input
                    ...
                    name="year"
                    value={
                      carData.year === null || carData.year === 0
                        ? ""
                        : carData.year
                    }
              ...
              <fieldset className="flex flex-col">
                <div className="flex items-center gap-2">
                  ...
                  <input
                    ...
                    name="mileage"
                    value={
                      carData.mileage === null || carData.mileage === 0
                        ? ""
                        : carData.mileage
                    }
                    onChange={handleInputChange}
              ...
              <fieldset className="flex flex-col">
                <div className="flex items-center gap-2">
                  ...
                  <input
                    ...
                    name="price"
                    value={
                      carData.price === null || carData.price === 0
                        ? ""
                        : carData.price
                    }
                    onChange={handleInputChange}
              ...
              <fieldset className="flex gap-2">
                <label
                  className="w-24 py-2 text-right text-neutral-700 dark:text-neutral-300"
                  htmlFor="description"
                >
                  Description
                </label>
