    ...
    <footer className="w-full bg-cyan-900 text-white mt-12">
      <div className="max-w-7xl mx-auto px-6 py-10 grid grid-cols-1 md:grid-cols-3 gap-8">
        <div>
          ...
          <p className="text-cyan-100/90">Gebrauchtwagen zu verkaufen. Der beste Ort, um Ihr nächstes Auto zu finden.</p>
        </div>
        <div>
        ...
        <div>
          ...
          <p className="text-cyan-100/90">Saalfeld, Deutschland</p>
          <p className="text-cyan-100/90">+49 123 456 7890</p>
          <p className="text-cyan-100/90">info@autohausplus.com</p>
        </div>
      </div>
