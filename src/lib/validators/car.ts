...
export const AddCarSchema = z.object({
  ...
  transmission: z.enum([Transmission.manual, Transmission.automatic], 'message.requiredTransmission'),
  fuelType: z.enum([FuelType.diesel, FuelType.petrol, FuelType.gas, FuelType.electric, FuelType.hybrid], 'message.requiredFuelType'),
